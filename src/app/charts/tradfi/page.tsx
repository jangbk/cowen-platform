    ...
    >
      <div className="relative h-20 mb-3 rounded-md bg-muted/30 overflow-hidden">
        <svg viewBox="0 0 200 60" className="w-full h-full" preserveAspectRatio="none">
          ...
          <path d={`${generateRandomLine(chart.id)} L200,60 L0,60 Z`} fill={`url(#grad-${chart.id})`} />
          <path d={generateRandomLine(chart.id)} fill="none" stroke={chart.color} strokeWidth="1.5" />
        </svg>
