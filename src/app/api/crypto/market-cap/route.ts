...
// Altcoin Market Cap milestones (Total - BTC)
const ALTCOIN_HISTORY: Array<[number, number]> = [
  [dateMs(2014, 1, 1), 1_000_000_000],
  [dateMs(2014, 6, 1), 2_000_000_000],
  [dateMs(2014, 10, 1), 2_500_000_000],
  [dateMs(2015, 1, 14), 1_000_000_000],
  [dateMs(2015, 7, 1), 1_500_000_000],
  [dateMs(2016, 1, 1), 1_000_000_000],
  [dateMs(2016, 6, 1), 2_200_000_000],
  [dateMs(2017, 1, 1), 2_500_000_000],
  [dateMs(2017, 3, 1), 5_000_000_000],
  [dateMs(2017, 5, 22), 55_000_000_000],   // ICO boom begins
  [dateMs(2017, 6, 12), 66_000_000_000],
  [dateMs(2017, 7, 17), 33_000_000_000],
  [dateMs(2017, 9, 1), 95_000_000_000],
  [dateMs(2017, 11, 1), 100_000_000_000],
  [dateMs(2017, 12, 7), 280_000_000_000],
  [dateMs(2018, 1, 7), 550_000_000_000],   // altcoin ATH (ICO peak)
  [dateMs(2018, 2, 6), 180_000_000_000],
  [dateMs(2018, 5, 5), 275_000_000_000],
  [dateMs(2018, 8, 14), 90_000_000_000],
  [dateMs(2018, 11, 25), 55_000_000_000],
  [dateMs(2018, 12, 15), 45_000_000_000],
  [dateMs(2019, 1, 1), 70_000_000_000],
  [dateMs(2019, 4, 1), 60_000_000_000],
  [dateMs(2019, 6, 26), 140_000_000_000],
  [dateMs(2019, 12, 1), 70_000_000_000],
  [dateMs(2020, 2, 14), 125_000_000_000],
  [dateMs(2020, 3, 13), 38_000_000_000],   // COVID crash
  [dateMs(2020, 5, 11), 80_000_000_000],
  [dateMs(2020, 8, 1), 170_000_000_000],   // DeFi summer
  [dateMs(2020, 11, 1), 150_000_000_000],
  [dateMs(2020, 12, 31), 230_000_000_000],
  [dateMs(2021, 1, 10), 290_000_000_000],
  [dateMs(2021, 2, 10), 660_000_000_000],  // alt season begins
  [dateMs(2021, 4, 14), 1_100_000_000_000],
  [dateMs(2021, 5, 12), 1_800_000_000_000], // alt season peak
  [dateMs(2021, 5, 19), 820_000_000_000],
  [dateMs(2021, 6, 22), 710_000_000_000],
  [dateMs(2021, 8, 1), 880_000_000_000],
  [dateMs(2021, 9, 7), 1_340_000_000_000],
  [dateMs(2021, 11, 10), 1_720_000_000_000], // ATH
  [dateMs(2021, 12, 4), 1_280_000_000_000],
  [dateMs(2022, 1, 1), 1_300_000_000_000],
  [dateMs(2022, 3, 28), 1_200_000_000_000],
  [dateMs(2022, 5, 12), 640_000_000_000],   // LUNA crash
  [dateMs(2022, 6, 18), 470_000_000_000],
  [dateMs(2022, 8, 15), 640_000_000_000],
  [dateMs(2022, 11, 9), 570_000_000_000],   // FTX
  [dateMs(2022, 12, 31), 480_000_000_000],
  [dateMs(2023, 2, 1), 570_000_000_000],
  [dateMs(2023, 4, 14), 710_000_000_000],
  [dateMs(2023, 6, 1), 620_000_000_000],
  [dateMs(2023, 10, 24), 630_000_000_000],
  [dateMs(2023, 12, 31), 870_000_000_000],
  [dateMs(2024, 3, 14), 1_300_000_000_000],
  [dateMs(2024, 4, 20), 1_150_000_000_000],
  [dateMs(2024, 8, 5), 850_000_000_000],
  [dateMs(2024, 11, 22), 1_500_000_000_000],
  [dateMs(2024, 12, 17), 1_600_000_000_000],
  [dateMs(2025, 1, 1), 1_440_000_000_000],
  [dateMs(2025, 2, 20), 1_300_000_000_000],
];

// Stablecoin Market Cap milestones (USDT launched 2014, meaningful from 2017)
const STABLECOIN_HISTORY: Array<[number, number]> = [
  [dateMs(2017, 1, 1), 10_000_000],
  [dateMs(2017, 6, 1), 50_000_000],
  [dateMs(2017, 12, 1), 1_300_000_000],
  [dateMs(2018, 1, 1), 1_600_000_000],
  [dateMs(2018, 4, 1), 2_500_000_000],
  [dateMs(2018, 7, 1), 2_800_000_000],
  [dateMs(2018, 10, 1), 2_800_000_000],
  [dateMs(2018, 12, 1), 2_000_000_000],
  [dateMs(2019, 3, 1), 2_800_000_000],
  [dateMs(2019, 6, 1), 3_500_000_000],
  [dateMs(2019, 9, 1), 4_500_000_000],
  [dateMs(2019, 12, 1), 5_200_000_000],
  [dateMs(2020, 3, 13), 6_000_000_000],    // COVID spike in stablecoin demand
  [dateMs(2020, 6, 1), 11_000_000_000],    // DeFi summer
  [dateMs(2020, 9, 1), 16_000_000_000],
  [dateMs(2020, 12, 31), 28_000_000_000],
  [dateMs(2021, 3, 1), 42_000_000_000],
  [dateMs(2021, 5, 12), 70_000_000_000],
  [dateMs(2021, 7, 1), 105_000_000_000],
  [dateMs(2021, 9, 1), 125_000_000_000],
  [dateMs(2021, 11, 10), 140_000_000_000],
  [dateMs(2021, 12, 31), 155_000_000_000],
  [dateMs(2022, 3, 1), 180_000_000_000],
  [dateMs(2022, 5, 12), 160_000_000_000],  // UST/LUNA collapse
  [dateMs(2022, 7, 1), 155_000_000_000],
  [dateMs(2022, 9, 1), 150_000_000_000],
  [dateMs(2022, 12, 31), 138_000_000_000],
  [dateMs(2023, 3, 1), 135_000_000_000],
  [dateMs(2023, 6, 1), 128_000_000_000],
  [dateMs(2023, 9, 1), 125_000_000_000],
  [dateMs(2023, 12, 31), 130_000_000_000],
  [dateMs(2024, 3, 14), 148_000_000_000],
  [dateMs(2024, 6, 1), 155_000_000_000],
  [dateMs(2024, 9, 1), 165_000_000_000],
  [dateMs(2024, 12, 17), 195_000_000_000],
  [dateMs(2025, 1, 1), 200_000_000_000],
  [dateMs(2025, 2, 20), 210_000_000_000],
];
...
const HISTORY_MAP: Record<string, Array<[number, number]>> = {
  ...
  total: TOTAL_HISTORY,
  eth: ETH_HISTORY,
  altcoin: ALTCOIN_HISTORY,
  stablecoin: STABLECOIN_HISTORY,
};
